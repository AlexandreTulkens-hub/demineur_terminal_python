...
#constantes
LONG = sys.argv[1]  # nombre de cases en longueur du plateau
LARG = sys.argv[2]  # nombre de cases en largeur du plateau
NB_MINES = sys.argv[3]  # nombre de mines dans le plateau
